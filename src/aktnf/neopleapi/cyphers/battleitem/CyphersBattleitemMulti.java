...
public class CyphersBattleitemMulti extends ApiRequestDecorator {
	...
	/*
	 * 다른거는 CyphersApiRequest에서 getRequestURL해서 뒤에 파라미터를 붙이면 됐는데 multi 붙은 이녀석은
	 * URL구조가 혼자 달라서 일단은 ApiRequest를 생성자에서 받긴 했는데 사용하지 않아 주석처리해놓음. 만약 나중에 multi
	 * 붙은것들이 더 추가된다면 CyphersBattleitemMulti를 CyphersMultiRequest 하위로 옮기고 사용할 예정.
	 */
	/*
